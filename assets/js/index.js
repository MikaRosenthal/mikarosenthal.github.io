console.log("%c欢迎来到我的个人社交主页", "color: #6d85c1; font-size: 2.5em;");
...
(function () {
    ...
    const data = '你好呀，我是一位可爱的女生哦，欢迎来到我的个人社交主页，来了解一下我吧！'.split('')
    let index = 0
...
let data = [{
    username: '岳',
    imgSrc: 'https://q2.qlogo.cn/headimg_dl?dst_uin=445158&spec=100',
    comments: '么么么！'
},
{
    username: '梦达亚',
    imgSrc: 'https://q2.qlogo.cn/headimg_dl?dst_uin=14754411&spec=100',
    comments: 'I‘m fan。'
}
]
